...
class NGOProfileEditPage extends StatefulWidget {

  @override
  _NGOProfileEditPageState createState() => _NGOProfileEditPageState();
}

class _NGOProfileEditPageState extends State<NGOProfileEditPage> {
  late String email;
  ...
  late var _address = TextEditingController(text: data!['address'].toString());
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              child: Form(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      validator: (value) {
                                        if (value!.isEmpty || value == 'Address') {
                                          return 'Please enter a valid email.';
                                        } else {
                                          address = value;
                                        }
                                      ...
                                      controller: _address,
                                      onTap: () {
                                        if (_address.text == data!['address'].toString()) {
                                          _address.clear();
                                        }
                                      },
                                      style: TextStyle(
                            ...
                            Center(
                              child: TextButton(
                                onPressed: () async {
                                  var response = await Navigator.push(context, MaterialPageRoute(builder: (context) => OptionsDialogueBox()));
                                  if (response == 'Yes') {
